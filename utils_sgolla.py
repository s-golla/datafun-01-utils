...
# ----------------------------------
author: str = "Saratchandra Golla"
organization: str = "Sgolla Analytics"
motto: str = "Clear. Useful. On time. Learn."

location: str = "O'Fallon, Missouri"
# ----------------------------------
...
office_locations: list[str] = ["St. Louis, MO", "Chicago, IL", "New York, NY"]
